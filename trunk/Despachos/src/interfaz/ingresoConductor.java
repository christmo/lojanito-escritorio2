/*//GEN-FIRST:event_txtTipoSangreFocusLost
 * ingresoConductor.java//GEN-LAST:event_txtTipoSangreFocusLost
 *
...
public class ingresoConductor extends javax.swing.JDialog {
    ...
    private void txtConyugeFocusLost(java.awt.event.FocusEvent evt) {                                     
        txtConyuge.setText(txtConyuge.getText().toUpperCase());
}                                    

    private void txtTipoSangreFocusLost(java.awt.event.FocusEvent evt) {                                        
    ...
    private void txtEstadoCivilFocusLost(java.awt.event.FocusEvent evt) {                                         
        txtEstadoCivil.setText(txtEstadoCivil.getText().toUpperCase());
}                                        

    private void txtNumCasaFocusLost(java.awt.event.FocusEvent evt) {                                     
        txtNumCasa.setText(txtNumCasa.getText().toUpperCase());
}                                    

    private void txtDireccionFocusLost(java.awt.event.FocusEvent evt) {                                       
        txtDireccion.setText(txtDireccion.getText().toUpperCase());
}                                      

    private void txtNomApeFocusLost(java.awt.event.FocusEvent evt) {                                    
